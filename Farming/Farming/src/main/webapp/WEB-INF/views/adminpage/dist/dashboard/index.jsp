  ...
  <div class="navbar-wrapper">
    ...
    <div class="navbar-content">
      <ul class="pc-navbar">
        ...
        <li class="pc-item">
          <a href="registerPage" class="pc-link">
      ...
      <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown p-0 overflow-hidden">
        <div class="dropdown-header d-flex align-items-center justify-content-between bg-primary">
          <div class="d-flex my-2">
            ...
            <div class="flex-grow-1 ms-3">
              <h6 class="text-white mb-1">Adminüññ</h6>
          ...
          <div class="col-md-6 col-xl-4">
              <div class="card">
                  <div class="card-body">
                      ...
                      <div class="row d-flex align-items-center">
                          <div class="col-9">
                              <h3 class="f-w-300 d-flex align-items-center  m-b-0"><i class="feather icon-arrow-down text-danger f-30 m-r-10"></i>$2.942.32</h3>
                          </div>
                          <div class="col-3 text-end">
                              <p class="m-b-0">36%</p>
                          </div>
          ...
          <div class="col-md-12 col-xl-4">
              <div class="card">
                  <div class="card-body">
                      ...
                      <div class="row d-flex align-items-center">
                          <div class="col-9">
                              <h3 class="f-w-300 d-flex align-items-center  m-b-0"><i class="feather icon-arrow-up text-success f-30 m-r-10"></i>$8.638.32</h3>
                          </div>
                          <div class="col-3 text-end">
                              <p class="m-b-0">80%</p>
                          </div>
              ...
              <div class="card user-list">
                  ...
                  <div class="card-body">
                      <div class="row align-items-center justify-content-center m-b-20">
                          <div class="col-6">
                              <h2 class="f-w-300 d-flex align-items-center float-start m-0">4.7 <i class="fas fa-star f-10 m-l-10 text-warning"></i></h2>
                          </div>
                          <div class="col-6">
                      ...
                      <div class="row">
                          ...
                          <div class="col-xl-12">
                              ...
                              <div class="progress m-t-30  m-b-20" style="height: 6px;">
                                  <div class="progress-bar bg-brand-color-1" role="progressbar" style="width: 35%;" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100"></div>
                              </div>
                          </div>
                          <div class="col-xl-12">
                              ...
                              <div class="progress m-t-30  m-b-20" style="height: 6px;">
                                  <div class="progress-bar bg-brand-color-1" role="progressbar" style="width: 25%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                              </div>
                          </div>
                          <div class="col-xl-12">
                              ...
                              <div class="progress m-t-30  m-b-20" style="height: 6px;">
                                  <div class="progress-bar bg-brand-color-1" role="progressbar" style="width: 10%;" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
                              </div>
                          </div>
                          <div class="col-xl-12">
